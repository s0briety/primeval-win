...
namespace ImGui
{
    ...
    IMGUI_API void          secondaryColored(const ImVec4& col, const char* fmt, ...)            IM_FMTARGS(2); // shortcut for PushStyleColor(ImGuiCol_Text, col); Text(fmt, ...); PopStyleColor();
    IMGUI_API void          secondaryColoredV(const ImVec4& col, const char* fmt, va_list args)  IM_FMTLIST(2);
