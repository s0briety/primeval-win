...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Colorful Text"))
        {
            ...
            ImGui::secondaryColored(ImVec4(1.0f, 0.0f, 1.0f, 1.0f), "Pink");
            ImGui::secondaryColored(ImVec4(1.0f, 1.0f, 0.0f, 1.0f), "Yellow");
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Basic Horizontal Layout"))
    {
        ...
        ImGui::secondaryColored(ImVec4(1, 1, 0, 1), "Sailor");
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            if (child_is_visible) // Avoid calling SetScrollHereY when running with culled items
            {
                for (int item = 0; item < 100; item++)
                {
                    ...
                    {
                        ImGui::secondaryColored(ImVec4(1, 1, 0, 1), "Item %d", item);
