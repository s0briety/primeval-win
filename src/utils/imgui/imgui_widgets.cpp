...
void ImGui::secondaryColored(const ImVec4& col, const char* fmt, ...)
{
    va_list args;
    va_start(args, fmt);
    secondaryColoredV(col, fmt, args);
    va_end(args);
}

void ImGui::secondaryColoredV(const ImVec4& col, const char* fmt, va_list args)
{
